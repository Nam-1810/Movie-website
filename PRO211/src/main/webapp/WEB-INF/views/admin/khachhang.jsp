				...
				<div class="col-xl-10 col-lg-10"
					...
					<div class="content">
									...
									<c:forEach var="kh" items="${khachhang}">
										<tr>
											...
											<td><fmt:parseDate pattern="yyyy-MM-dd"
													value="${kh.ngaySinh}" var="parsedDate" /> <fmt:formatDate
											...
											<td>${kh.diaChi}</td>
											<td>${kh.matKhau}</td>
											<td><a href="/admin/khachhang/edit/${kh.maKhachHang}">Edit</a></td>
											<td><a href="/admin/khachhang/delete/${kh.maKhachHang}">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						...
						<div class="p-3 mb-2 bg-dark text-white">${message}</div>
							<form:form method="post" action="admin/khachhang/create"
								modelAttribute="form">
								<div class="row">

									<form:input path="maKhachHang" readonly="true" type="hidden"
										class="form-control" />
								...
								<div class="row">
									...
									<div class="form-group col">
										<label>Ngày sinh</label> <input type="date"
											class="form-control" id="ngaySinh1" value="${form.ngaySinh}"
								...
								<div class="form-group">
									<button formaction="/admin/khachhang/create"
										class="btn btn-success">Save</button>
									<button class="btn btn-alert"
										formaction="/admin/khachhang/clear" ${button}>Clear</button>
									<button class="btn btn-warning" formaction="/admin/khachhang"
										${_new}>New</button>
								</div>
							</form:form>
						</div>
